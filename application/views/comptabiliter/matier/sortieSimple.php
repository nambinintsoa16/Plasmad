...
$('.tableSortie > tr').each(function(){
 ...
 $('.tableSortie > tr').each(function(){
    ...
    var machine = $(this).children().eq(0).text();
   $.post(base_url+"Magasiner/sortieMatier",{machine:machine,produitForn:produitForn,receptQuantite:receptQuantite,prix:prix,reference:reference},function(){
        if(i==0){
