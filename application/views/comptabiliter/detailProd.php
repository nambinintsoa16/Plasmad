<div class="card w-100">
	<div class="card-header bg-dark text-white">
		<b>DETAIL : <span><?=$PO?></span></b>
	</div>
	<div class="card-body">
		<fieldset class="border p-1">

			<legend style="font-size:12px">PRODUCTION</legend>

			<nav>
				<div class="nav nav-tabs" id="nav-tab" role="tablist">
					<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
						aria-controls="nav-home" aria-selected="true">EXTRUSION</a>
					<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
						aria-controls="nav-profile" aria-selected="false">IMPRESSION</a>
					<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab"
						aria-controls="nav-contact" aria-selected="false">COUPE</a>
				</div>
			</nav>
		...
		<fieldset class="border p-1 mt-2">
			<legend style="font-size:12px">MATIERE</legend>
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="matier" role="tabpanel" aria-labelledby="nav-home-tab">
					<table class="table-hover table-strepted w-100 table-bordered tadleData">
						...
						<?php foreach($matier as $matier):?>
							<tr>
							    <td><?=$matier->LI_MATIER?></td>
								<td><?=$matier->LI_QUANTITE?></td>
								<td><?=$matier->LI_VALEUR?></td>
						</tr>	
