<div class="card bg-default w-100 p-0 m-0">
...
$('.changeDate').on('click',function(){
	var page = "SUIVIE LIVRAISON";
	var date = $('.choixdate').val();
	var po = $('.po').val();
	chargement();
	$.post(base_url+"Controlleur/page",{page:page,date:date,po:po},function(data){
