...
<script>
  $('document').ready(function() {
    chargement();
    $.post(base_url + 'Controlleur/tableProcessus', {
      page: "EXTRUSION"
    }, function(data) {
    ...
    function processusExtrusion() {
      $.post(base_url + 'Controlleur/dataExtrusion', {
        param: "EXTRUSION"
      }, function(data) {
    ...
    function processusInjection() {
      $.post(base_url + 'Controlleur/dataInjection', {
        param: "INJECTION"
      }, function(data) {
        $('.processus-cont').empty().append(data);
        closeDialog();
    ...
    function proxcessuxExtrusionAction() {
      ...
      $('.terminerPro').on('click', function(event) {
        ...
        swal({
          ...
          if (Delete) {
            $.post(base_url + 'Controlleur/updateJobsTerminer', {
              parent: parent
            }, function(data) {
              swal({
                title: 'Succè!',
