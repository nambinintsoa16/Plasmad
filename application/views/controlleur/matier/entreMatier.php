...
$(document).ready(function(){
 Table = $('.tableEntreMat').DataTable({
    processing: true,
            ajax:"controlleur/lisete_entre_materiel?debut=&fin=",
         language: {
  ...
  function deleteSortie(){
     $('.delete').on('click',function(e){
       e.preventDefault();
        ...
        $.post(base_url+'controlleur/deleteTransactionEntre',{id,type,idstock},function(data){
          Table.ajax.url("controlleur/lisete_entre_materiel");
          Table.ajax.reload();
        });
     });
  }
