<div class="card w-100">
   <div class="card-header bg-dark text-white">
      ...
      <b class="pull-right text-white"><a href="<?=base_url("Magasiner/exportsortieProduitFini")?>" class="text-white btn btn-warning mb-1 btn-sm"><i class="fa fa-download"></i>&nbsp;EXPORTE</a></b>
   </div>
<div class="card-body">
