<div class="card w-100">
	<div class="card-header bg-dark text-white">
		...
		<b class="pull-right">
         <input type="date" name="" class="dateDebut">
         <input type="date" name="" class="dateFin">
         <button class="btn btn-success btn-sm mb-1 afficheData"><i class="fa fa-tv"></i> Afficher</button>
...
<script>
	...
	var Table = $(".tableProduitFini").dataTable({
			processing: true,
	...
	$('.afficheData').on('click',function(e){
		e.preventDefault();
		  var dateDebut = $('.dateDebut').val();
	      var dateFin = $('.dateFin').val();
	      var links = base_url + "Magasiner/dataProduitFini?dateDebut="+dateDebut+"&dateFin="+dateFin;
