...
<fieldset class="col-md-12 border mt-2">  
        <div class="row ">
               ...
               <div class="form-group">
                    <label>PDS NET</label>
                    <input type="text" name="VM_PDSNET" class="form-control form-control-sm VM_PDSNET" value="<?php 
                       if(!empty($last)){
                          echo  $last->EX_PDS_SOMME;
                       }
                    ?>">  
               </div> 
                <?php if($me):?>
               <div class="form-group">
                    <label>RESTE 1</label>
                    <input type="text" name="VM_R1" value="<?=$last->EX_PDS_SOMME-$me->VM_R1  ?>" class="form-control form-control-sm VM_R1">  
               </div> 
               <div class="form-group">
                    <label>RESTE 2</label>
                    <input type="text" name="VM_R2"  value="<?=($last->EX_PDS_SOMME-$me->VM_R1)*-1  ?>" class="form-control form-control-sm VM_R2" >  
               </div>  
                <?php else: ?>
                <div class="form-group">
                    <label>RESTE 1</label>
