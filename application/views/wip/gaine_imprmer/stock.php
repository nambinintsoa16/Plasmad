<fieldset class="col-md-12 border w-100 p-3 bg-white">
    <b class="pull-right">
        <input type="date" id="date_debut" name="date">
        <input type="date" id="date_fin" name="date">
        <a href="#" class="btn btn-success btn-sm" id="affiche_data"><i class="fa fa-tv"></i>&nbsp; AFFICHER</a>
    </b>
</fieldset>
