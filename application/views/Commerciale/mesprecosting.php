...
<div class="form-group col-md-12 form-inline">
     ...
     <select name="anneé" id="moisliste" class="form-control form-control-sm">
             ...
             <?php $p = 1; foreach (listemois() as $key => $listemois):?>
...
<fieldset class="border mt-3 p-3"> 
    ...
    <div class="row"> 
        ...
        <div class="col-md-12">
            ...
            <a href="#" class="btn btn-sm btn-primary col-md-3 pull-right recherche">Afficher</a>   
...
<div class="form-group col-md-12">
   ...
   <table class="table dataTableLite table-hover table-bordered table-hover table-bordered-bd-warning">
        ...
        <div class="row">  
        	...
        	<div class="form-group col-md-4">
				...
				<div class="form-group col-md-4">
				 ...
				 <input type="number" name="BC_PRIX" class="form-control form-control-sm BC_PRIX">
...
<fieldset class="col-md-12 border mt-2">
   ...
   <div class="card-footer text-right"> 
         ...
         <button type="submit" class="btn btn-success UpdateCommande">Modifier</button>
