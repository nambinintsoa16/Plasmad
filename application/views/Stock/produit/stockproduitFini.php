<div class="card w-100">
	<div class="card-header bg-dark text-white">
		...
		<b class="pull-right">
			...
			<a href="<?=base_url("magasiner/exportStockSortie?debut=&fin=")?>"
				class="btn btn-primary btn-sm exportSortie"><i class="fa fa-download"></i>&nbsp; EXPORTE</a>
			<a href="<?=base_url("magasiner/printStockSortie?debut=&fin=")?>"
				class="btn btn-warning btn-sm printSortie"><i class="fa fa-print"></i>&nbsp; IMPRIMER</a>
		</b>
	</div>
	<div class="card-body">
		...
		<fieldset class="col-md-12 border mt-2 w-100 pt-3">
			<table class=" table-sm table-bordered table-hover table-strepted tableProduitFini w-100">
							...
							<fieldset class="col-md-12 border">
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" name="BC_CLIENT" disabled
											class="form-control form-control-sm BC_TYPEPRODUIT ">
									</div>
									...
									<div class="form-group col-md-3">
										...
										<input type="text" name="BC_CODE" disabled
											class="form-control form-control-sm BC_CODE">
									</div>
									<div class="form-group col-md-3">
										<label for="BC_DATELIVRE">Date de livraison : </label>
										<input type="date" name="BC_DATELIVRE" disabled
							...
							<fieldset class="col-md-12 border mt-2">
								<div class="row">
									<div class="form-group col-md-4">
										...
										<input type="text" name="BC_PRIX" disabled
											class="form-control form-control-sm BC_TYPEMATIER">
									</div>
									<div class="form-group col-md-4">
										<label for="BC_TYPEMATIER">QUANTITE A PRODUIRE EN METRE : </label>
										<input type="text" name="BC_PRIX" disabled
											class="form-control form-control-sm BC_QUANTITEAPRODUIREENMETRE">
									</div>
									<div class="form-group col-md-4">
										<label for="BC_TYPEMATIER">POIDS EN KG : </label>
										<input type="text" name="BC_PRIX" disabled
											class="form-control form-control-sm BC_POISENKGSAVECMARGE">

									</div>

									<div class="form-group col-md-4">
										<label for="BC_QUNTITE">Quantité : </label>
										<input type="text" name="BC_QUNTITE" disabled
											class="form-control form-control-sm BC_QUNTITE">
									</div>
									<div class="form-group col-md-4">
										<label for="BC_PRIX">Prix : </label>
										<input type="text" name="BC_PRIX" disabled
											class="form-control form-control-sm BC_PRIX">
									</div>
								</div>
					</div>
					</fieldset>
...
<script>
	$(document).ready(function () {
		...
		Tables = $(".tableProduitFini").dataTable({
			processing: true,
			ajax: base_url + "Stock/dataProduitFini?debut=&fin=",
			language: {
			...
			initComplete: function (setting) {
				$('.infoProduit').on('click', function (event) {
					...
					var pe = $(this).attr('href');
					$.post(base_url + "Stock/detailBon", {
						pe: pe
					}, function (data) {
						...
						$(".BC_QUANTITEAPRODUIREENMETRE").val(data
							.BC_QUANTITEAPRODUIREENMETRE);
		...
		$('.afficher').on('click', function (e) {
			...
			var links = base_url + "Stock/dataProduitFini?debut=" + debut + "&fin=" + fin;
