...
<div class="form-group col-md-3">
   ...
   <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" id="quantite" class="form-control localisation form-control-sm" name="local">
    </div>
    ...
    $(document).ready(function(){
      ...
      select : function(data,iteme){
         var param= iteme.item.value.trim();
			$.post(base_url+"Stock/recherchePE",{param:param},function(data){
