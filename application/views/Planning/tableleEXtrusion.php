...
$this->load->model('Planning_model'); 
     foreach($data as $data):
      $rep = "";
      $av= "";
	  if(!empty($data->JO_SORTIE) && !empty($data->JO_AV)){
...
?>
       	<tr <?php if($data->JO_ETAT=='on'){echo "style='background:yellow;'";}?>>
			 ...
			 <td>	
			   ...
			   <td><?=$data->JO_OBS?></td>
			  <td><a href="#" class="btn btn-info btn-sm changehour"><i class="icon-wrench"></i> </a></td>
			  <td>
			 <a href="#" class="btn btn-secondary btn-sm change_machine"><i class="fa fa-arrow-alt-circle-down"></i></a>
			 </td>

			 <td>
			 <a href="#" class="btn btn-warning btn-sm editP"><i class="fa fa-edit"></i></a>
			 </td>
			<?php if($data->BC_PROCCESSUS != "COUPE_EXTRUSION" OR $data->BC_PROCCESSUS != "HOOK"):?>
				<td>
				   <a href="#" class="btn btn-primary btn-sm editProcessus"><i class="fa fa-arrow-right"></i></a>
			    </td>
			<?php else:?>
			   <td>
			    <td>
				   <a href="#" class="btn btn-primary btn-sm disabled" disabled ><i class="fa fa-arrow-right"></i></a>
			    </td>
			   </td>
			<?php endif;?>
				<td>
					<a href="#" class="btn btn-success btn-sm terminerPro"><i class="fa fa-check"></i></a>
			    </td>
			    <td>
					<a href="#" class="btn btn-danger btn-sm delete"><i class="fa fa-times"></i></a>
			    </td>
			     <td>
					<a href="#" class="btn btn-secondary btn-sm updateDate"><i class="fa fa-upload"></i></a>
			    </td>
       	</tr>	
    <?php endforeach;?>  
    </tbody>
