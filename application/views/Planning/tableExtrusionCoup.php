...
<div class="col-md-12 p-2 bg-dark text-white">
		...
		<span><a href="<?=base_url("Planning/exportMachineDataCoupe?machine=$machine->MA_DESIGNATION");?>" class="text-success"><i class="fa fa-print"></i></a></span>
    ...
    <div clas="row pt-2 w-100" >
        <div class="col-md-12 w-100">
            ...
            <div class="w-100" id="tab_<?=$machine->MA_ID?>" style="padding: 0px;">
				...
				$this->load->view('Planning\tableCoupData',$data); ?>
            </div></fieldset>
		</div>
	</div>
<?php endforeach;?>			
