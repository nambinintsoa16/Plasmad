					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<select class="form-control BC_STATUT form-control-sm" name="BC_STATUT">
							    <option value="INPRESSION_INJECTION">INJECTION</option>
								<option value="INPRESSION_INJECTION">INPRESSION</option>
								<option value="HOOK">HOOK</option>
							</select>
						</div>
						<div class="form-group col-md-4">
							<label for="DJ_MACHINE">MACHINE</label>
							<select class="form-control DJ_MACHINE" name="DJ_MACHINE">
