     ...
     <fieldset class="border p-3">
       <div class="col-sm-12 ">
         <div class="row text-rigth">
           ...
           <input type="text" name="" class="form-control form-control-sm col-md-2 recherchePos ml-2">
 ...
 <script type="text/javascript">
   $(document).ready(function() {
     ...
     $('.afficheDefult').on('click', function(e) {
       ...
       $.post(base_url + "Planning/page_jobs", {
         date: date,
         PO:PO,
         page: "NON PLANNIFIER"
       }, function(data) {
     ...
     $('.UpdateCommande').on('click', function(e) {
       ...
       $('.tbody-modaltable tr').each(function(index) {
         ...
         $.post(base_url + 'Planning/saveMartierPr', {
           BC_PE: BC_PE,
           MU_DESIGNATION: MU_DESIGNATION,
           MU_QUANTITE: MU_QUANTITE,
           MU_PRIX: MU_PRIX
         }, function() {
       ...
       $.post(base_url + 'Planning/createJobScartEtat1', {
         POIDSSACHET: POIDSSACHET,
         BC_PE: BC_PE.trim(),
         BC_QUANTITEAPRODUIREENMETRE: BC_QUANTITEAPRODUIREENMETRE,
         BC_POISENKGSAVECMARGE: BC_POISENKGSAVECMARGE,
         BC_DIMENSIONPROD: BC_DIMENSIONPROD,
         BC_ROULEAUX: BC_ROULEAUX
       }, function(data) {
         $('input').val("");
