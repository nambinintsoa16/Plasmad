...
$('.affincher').on('click',function(e){
    ...
    var date = $('.date').val();
    var specification = $('.machine option:selected').val();
    $.post(base_url+"Planning/page",{page:"recapMachine",machine:machine,date:date,specification:specification},function(data){
