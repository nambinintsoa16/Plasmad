$(document).ready(function() {
    chargement();
    $.post(base_url + "Stock/page", { page: "PRODUIT FINI EN SURPLUS" }, function(data) {
    ...
    $('.btn-click').on('click', function(e) {
        ...
        $.post(base_url + "Stock/page", { page: page }, function(data) {
            $('.main').empty().append(data);
            $('.link').text(page);
            if (page == "PRODUIT FINI EN SURPLUS") {
                produit();
    ...
    function sortie() {
        ...
        $('.saveTransaction').on('click', function(e) {
            ...
            JSON.s
            $.post(base_url + 'Stock/saurSortie', { data: donne, date: datesortie, reception: reception, PE: PE }, function(data) {
    ...
    function actionMatierPremier() {
        ...
        $('form').on('submit', function(event) {
            ...
            $.ajax({
                ...
                url: base_url + 'Stock/update_matierPremier',
                type: 'post',
                data: fd,
                contentType: false,
                processData: false,
    ...
    function sortieMPremier() {
        $.post(base_url + "Stock/page", { page: "SORTIE_BON DE COMMANDE" }, function(data) {
        ...
        $('.typeSortie').on('change', function(event) {
            ...
            $.post(base_url + "Stock/page", { page: "SORTIE_" + page }, function(data) {
                $('.contTypeAction').empty().append(data);
    ...
    function echange() {
        ...
        $('.saveEchange').on('click', function(event) {
            ...
            $.post(base_url + "Stock/echange", { fornisseur: fornisseur, produitForn: produitForn, quantiteForn: quantiteForn, receptQuantite: receptQuantite, receptProduit: receptProduit, recept: recept }, function(data) {
                if (data.type == "error") {
            ...
            swal({
                ...
                if (Delete) {
                    ...
                    $.post(link, { po: po, matier: parent, quantite: quantite }, function(data) {
                        $.post(base_url + 'Stock/chercheMateir', { po: po }, function(datas) {
    ...
    function matierPremier() {
        chargement();
        $.post(base_url + "Stock/page", { page: "STOCK MATIERE PREMIERE" }, function(data) {
        ...
        $('.btn-click-link').on('click', function(e) {
            ...
            $.post(base_url + "Stock/page", { page: page }, function(data) {
                $('.main-matier').empty().append(data);
                $('.link').text("PRODUIT FINI EN SURPLUS / " + page);
                if (page == "SORTIE MATIERE PREMIERE") {
                    sortieMPremier();
    ...
    function SORTIESTK() {
        $('.auto').autocomplete({
            source: base_url + "Stock/autocompletSortie",
            select: function(data, iteme) {
                var param = iteme.item.value.trim();
                $.post(base_url + "Stock/recherchePESort", { param: param }, function(data) {
    ...
    function actinApprove() {
        ...
        $('form').on('submit', function(event) {
            ...
            var reference = $('.reference').val();
            $.post(base_url + "Stock/saveApprove", { reference: reference, designation: designation, quantite: quantite, date: date, forniseur: forniseur }, function(data) {
                if (data.type == "error") {
    ...
    function cherchePo() {
        $('.recherchePos').autocomplete({
            source: base_url + "Stock/autocompletPo",
        });

        $('.recherchePosBtn').on('click', function(event) {
            event.preventDefault();
            var po = $('.recherchePos').val();
            $.post(base_url + 'Stock/chercheMateir', { po: po }, function(data) {
