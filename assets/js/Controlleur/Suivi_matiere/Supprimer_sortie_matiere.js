$(document).ready(function() {
    table = $('#dataTable_entree_matiere').DataTable({
        processing: true,
        ajax: base_url + "controlleur/sortie_matiere_liste_data",
        language: {
    ...
    function delete_function() {
        $(".delete_matiere").on('click', function(event) {
            ...
            $.post(base_url + "controlleur/delete_sortie_matiere", { refnum }, function() {

            }).done(() => {
                table.ajax.reload();
                alertMessage("Succè!", "Opérateur supprimé.", "success", "btn btn-success");
            }).fail(() => {
    ...
    $('#check_cherche').on('click', function(event) {
        ...
        let link = base_url + "controlleur/sortie_matiere_liste_data";
        ...
        if (methodOk) {
            ...
            link = base_url + "controlleur/sortie_matiere_liste_data?date_de_debut=" + date_de_debut + "&date_fin=" + date_fin;
        }
        ...
        if (!methodOk) {
            ...
            if (methodOk) {
                ...
                link = base_url + "controlleur/sortie_matiere_liste_data?date_de_debut=" + date_de_debut;
            }
        }
