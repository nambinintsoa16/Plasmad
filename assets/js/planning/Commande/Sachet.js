$(document).ready(function() {
    ...
    let link = base_url + 'planning/recherche_commande_specifique';
    ...
    $('.recherche').on('click', function(event) {
        ...
        var debut = $('.debut').val();
        var fin = $('.fin').val();
        var links = base_url + "planning/recherche_commande_specifique/?anne=" + anneliste + "&mois=" + moisliste + "&debut=" + debut + "&fin=" + fin;
